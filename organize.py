...
for file_name in list_of_files:
    ...
    if extension == '':
        continue
    if extension in ['.gif', '.png', '.jpg', '.jpeg','.jfif','.PNG']:

        path1 = from_dir + '/' + file_name                       # Example path1 : Downloads/ImageName1.jpg        
        path2 = to_dir + '/' + "New_Image_Files"                     # Example path2 : D:/My Files/Image_Files      
        path3 = to_dir + '/' + "New_Image_Files" + '/' + "newFile of "+file_name   # Example path3 : D:/My Files/Image_Files/ImageName1.jpg
        #print("path1 " , path1)
        #print("path3 ", path3)
